...
import com.meishi.MyAdapter_meishi.Info;
...
public class MyAdapter_shopping  extends BaseAdapter{
	private List<Map<String, Object>> data;
    private LayoutInflater layoutInflater;
    private Context context;

    public MyAdapter_shopping(Context context, List<Map<String, Object>> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        // TODO Auto-generated method stub
        Info info = new Info();
        convertView = layoutInflater.inflate(R.layout.shopping_list, null);
        
        info.imgs = (ImageView) convertView.findViewById(R.id.shop_img);
        info.addrs= (TextView) convertView
                .findViewById(R.id.shop_attr);
        info.titles = (TextView) convertView
                .findViewById(R.id.shop_title);

        //设置数据
  //      info.img.setImageResource((Integer) data.get(position).get("imgs"));
        info.addrs.setText((String) data.get(position).get(
                "addrs"));
