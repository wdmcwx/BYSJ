...
public class MyAdapter_meishi extends BaseAdapter{
	 	private List<Map<String, Object>> data;
	    private LayoutInflater layoutInflater;
	    private Context context;

	    public MyAdapter_meishi(Context context, List<Map<String, Object>> data) {
	    ...
	    public View getView(int position, View convertView, ViewGroup parent) {
	        // TODO Auto-generated method stub
	        Info info = new Info();
	        convertView = layoutInflater.inflate(R.layout.meishi_listview, null);
	        
	        info.imgs = (ImageView) convertView.findViewById(R.id.ms_img);
	        info.names= (TextView) convertView
	                .findViewById(R.id.ms_name);
	        info.caixis = (TextView) convertView
	                .findViewById(R.id.ms_caixi);
	        info.summarys = (TextView) convertView
	                .findViewById(R.id.ms_summarys);

	        //设置数据
	  //      info.img.setImageResource((Integer) data.get(position).get("imgs"));
	        info.names.setText((String) data.get(position).get(
	                "names"));
	        info.caixis.setText((String) data.get(position).get(
	                "caixi"));
